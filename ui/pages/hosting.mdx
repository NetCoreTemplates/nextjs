...
### [nextjs-gh.web-templates.io](https://nextjs-gh.web-templates.io)
...
### [nextjs.web-templates.io](https://nextjs.web-templates.io)

Or when served from the CDN at [nextjs-gh.web-templates.io](https://nextjs-gh.web-templates.io), only its back-end 
